...
class Gidoc_TiposdocumentosController extends MyZend_Generic_ControllerAdmin
{
    /**
     *
     * @var Formulario
    ...
    public function init()
    {
        ...
        $this->_modelo = new  Gidoc_Model_TiposdocumentoMapper();
        $this->_form = new Gidoc_Form_Tiposdocumento();
        ...
        $this->view->colNames = "'Descripción','Descripción corta'";
        $this->view->colModel = "{name:'descripcion', index:'descripcion', width:400},
                                 {name:'descripcion_corta', index:'descripcion_corta', width:200}";
        ...
        $this->view->fieldFocus = 'descripcion';
    ...
    /**
     * Lista los Tiposdocumentoes existentes
     */
    public function listarAction()
    {
        ...
        $where = "descripcion||descripcion_corta ILIKE '%$txtBuscar%'";
        ...
        foreach ($rsArray as $fila) {
            $id = $fila['id'];
            $linkEdita = "<a href='#' onClick=editaDesdeLink($id) >" . $fila['descripcion']."</a>";

            $response->rows[$i]['id'] = $id;
            $response->rows[$i]['cell'] = array($linkEdita, $fila['descripcion_corta']);
            $i++;
        }
    ...
    public function agregarAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            /* Creo mi objeto */
            $data = array('descripcion'     => $form->descripcion->getValue(),
                          'descripcion_corta'  => $form->descripcion_corta->getValue(),
