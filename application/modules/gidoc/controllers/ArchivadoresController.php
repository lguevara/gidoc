...
class Gidoc_ArchivadoresController extends MyZend_Generic_ControllerAdmin
{
    /**
     *
     * @var Formulario
    ...
    public function init()
    {
        ...
        $this->_modelo = new  Gidoc_Model_ArchivadorMapper();
        $this->_form = new Gidoc_Form_Archivador();
        ...
        $this->view->colNames = "'Nombre','Periodo'";
        $this->view->colModel = "{name:'nombre', index:'nombre', width:400},
                                 {name:'periodo', index:'periodo', width:200}";
    ...
    /**
     * Lista los Archivadores existentes
     */
    public function listarAction()
    {
        ...
        /* Para ver solo los archivadore del usuario activo */
        $where = "dependencia_id = " . $this->_usuario->dependencia_id . " AND ";
        

        $where .= "nombre||periodo ILIKE '%$txtBuscar%'";
        ...
        foreach ($rsArray as $fila) {
            ...
            $response->rows[$i]['cell'] = array($linkEdita, $fila['periodo']);
            $i++;
        }
