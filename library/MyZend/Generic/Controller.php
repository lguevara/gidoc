...
abstract class MyZend_Generic_Controller extends Zend_Controller_Action
{
	...
	/* Asigno la url base de la aplicación */
        ...
        /* Asigno la url de la ubicación de los reportes */
        $this->view->urlReportes = $this->_config->general->urlReportes;
        
    }

    public function preDispatch()
    {
        $this->_helper->layout->assign("usuario", Default_Model_LoginModelo::getIdentity());
    }
