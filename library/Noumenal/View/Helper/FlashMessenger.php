...
class Noumenal_View_Helper_FlashMessenger extends Zend_View_Helper_Abstract
{
    ...
    private function _getJqueryTemplate($messageLevel)
    {
        switch($messageLevel) {
                case 'error':
                        $template = '
                                <div class="ui-state-error ui-corner-all" style="position:absolute; padding: 0pt 0.7em;">
                ...
                default:
                        $template = '
                                <div class="ui-state-highlight ui-corner-all" style="position:absolute; padding: 0pt 0.7em;">
