...
// +------------------------------------------------------------------------+
// | Copyright (c) Jorge PerÃ©z Vega 2007. All rights reserved.              |
// | Version       0.25                                                     |
 ...
 *
 * @version   0.25
 * @author    Jorge PerÃ©z Vega (jorge@cocoroto.com)
 * @license   http://opensource.org/licenses/gpl-license.php GNU Public License
 * @copyright Jorge PerÃ©z Vega
 * @package   cmf
 * @subpackage external
 */
    ...
    $translation['uploaded_too_big_html']       = 'Error al cargar el archivo (el archivo cargado excede la directiva MAX_FILE_SIZE que se especificÃ³ en el formulario html).';
    $translation['uploaded_partial']            = 'Error al cargar el archivo (el archivo solo fue cargado parcialmente).';
    $translation['uploaded_missing']            = 'Error al cargar el archivo (el archivo no se ha cargado).';
    $translation['uploaded_no_tmp_dir']         = 'Error al cargar el archivo (falta una carpeta temporal).';
    $translation['uploaded_cant_write']         = 'Error al cargar el archivo (Falló la escritura del archivo en el disco).';
    $translation['uploaded_err_extension']      = 'Error al cargar el archivo (Carga de archivo se detuvo por extensión).';
    ...
    $translation['source_invalid']              = 'Imposible leer la imagen fuente. Â¿Es una imagen?.';
